...
interface ShareFilingInfoFormProps {
  accountantEmail?: string | null;
  selectedYear?: string;
}

export function ShareFilingInfoForm({ 
  accountantEmail,
  selectedYear = new Date().getFullYear().toString()
}: ShareFilingInfoFormProps) {
      ...
      <div className="space-y-6">
        ...
        <div>
          <p className="text-lg font-bold text-gray-900">
            Send packet to your Tax Pro to file for {selectedYear}
